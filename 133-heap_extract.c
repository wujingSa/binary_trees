...
/**
 * count_heap_nodes - Counts the number of nodes in a binary tree
 ...
 *
 * This function finds the parent node for a given node in a binary tree.
 *
 ...
 *
 * This function removes the last node of a heap and ensures
 ...
 *
 * This function extracts the max val from a heap and maintains the heap
 * property
 *
